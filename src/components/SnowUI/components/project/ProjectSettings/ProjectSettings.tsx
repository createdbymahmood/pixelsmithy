...
import {SettingsCard} from '@/components/SnowUI'
...
function NameSettings() {
  return <SettingsCard title='Project Name'>Snow UI</SettingsCard>
}
...
function ProjectDescriptionSettings() {
  return (
    <SettingsCard title='Project Description'>
      SnowUI is a design system and UI Kit created with Figma. All of the
      products here use the SnowUI Library as the main component library.
    </SettingsCard>
  )
}
